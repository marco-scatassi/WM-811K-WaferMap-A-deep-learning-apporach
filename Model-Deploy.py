...
if __name__ == '__main__':
  ...
  st.markdown(
    ...
    "Selecting a type of failure will show you 10 images associated with that specific defect. Clicking in the button under a certain image you can see the " +
    "<span style='font-weight:bold'> class predicted </span> for that image by the model and the **probability of belonging to each class** (i.e. the output of the model)."
